...
python -m src.models.superpoint.synthetic_shapes \
...
python -m src.models.superpoint.finetune_superpoint \
...
python -m src.models.superpoint.prepare_uav_data \
...
python -m src.models.superpoint.homographic_adaptation \
